...
void setup() {
  ...
  dumpMemory();
  */
  getCounter(&fram_iterator);   // set the write location
}

/* Sets the static write location in FRAM (starting point to write to) */
void getCounter (uint32_t *iterator) {
...
void loop() {
  ...
  // convert temperature, time to byte array
